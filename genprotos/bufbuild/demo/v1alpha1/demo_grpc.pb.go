...
func (c *demoServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bufbuild.demo.v1alpha1.DemoService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DemoService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bufbuild.demo.v1alpha1.DemoService/SayHello",
	}
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bufbuild.demo.v1alpha1.DemoService",
	...
	Metadata: "bufbuild/demo/v1alpha1/demo.proto",
}
